...
@section('title', 'Reset Password - TripLodge Universe')
    ...
    <div class="max-w-md w-full bg-[#E69500]/20 rounded-2xl shadow-2xl overflow-hidden animate-fadeInUp backdrop-blur-sm">
        ...
        <div class="p-8">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-300 text-sm mt-2">Enter the 6-digit OTP sent to your email</p>
                <p class="text-[#E69500] text-xs mt-1">{{ $email ?? session('reset_email') }}</p>
            </div>
